...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'a5d3c82c27004a738dca283650bf1220',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小黑先生', // 您的昵称 例如 tangly1024
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mrnigrum@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '闽ICP备19016318号-3', // 备案号 闽ICP备XXXXXXX
